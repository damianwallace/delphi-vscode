...
| returns undefined when no .delphilsp.json exists in the tree | ✅ PASS | 1 |  |

## _idelaunchedForDirs deduplication

| Test | Result | ms | Error |
|------|--------|----|-------|
| _idelaunchedForDirs: IDE launched once for a dir, not twice on repeated initConfig call | ✅ PASS | 67 |  |
...
| findConfigInDir: returns path when .delphilsp.json exists in dir | ✅ PASS | 2 |  |
